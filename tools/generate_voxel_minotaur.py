...
PART_SPECS: tuple[PartSpec, ...] = (
    ...
    PartSpec("rye_skirt_side_left", (-14.25, 1.0, 37.5), (1.5, 10.0, 5.0), "cloth_high", "Pelvis"),
    PartSpec("rye_skirt_side_right", (14.25, 1.0, 37.5), (1.5, 10.0, 5.0), "cloth_high", "Pelvis"),
    ...
    # The moss tail drapes forward to the authored -16px depth boundary while
    # retaining its Z-face contact with moss_twist_left.
    PartSpec("moss_tip_left", (-14.5, -10.0, 33.0), (2.0, 12.0, 2.0), "moss_deep", "Pelvis"),
    ...
    PartSpec("abdomen_keel", (0.0, 0.0, 46.5), (18.0, 12.0, 5.0), "fur_deep", "Torso"),
    PartSpec("high_chest_core", (0.0, 1.0, 52.0), (23.0, 14.0, 6.0), "fur_mid", "Torso"),
    PartSpec("chest_flank_left", (-13.25, 1.0, 52.0), (3.5, 10.0, 4.0), "fur_deep", "Torso"),
    PartSpec("chest_flank_right", (13.25, 1.0, 52.0), (3.5, 10.0, 4.0), "fur_deep", "Torso"),
    PartSpec("high_shoulder_yoke", (0.0, 1.0, 57.5), (26.0, 12.0, 5.0), "fur_high", "Torso"),
    ...
    PartSpec("shoulder_strap_left", (-9.5, -5.5, 56.5), (3.0, 1.0, 3.0), "strap_deep_brown", "Torso"),
    PartSpec("shoulder_strap_right", (9.5, -5.5, 56.5), (3.0, 1.0, 3.0), "strap_deep_brown", "Torso"),
    PartSpec("chest_strap_left", (-8.5, -6.5, 52.0), (3.0, 1.0, 6.0), "strap_mid_brown", "Torso"),
    PartSpec("chest_strap_right", (8.5, -6.5, 52.0), (3.0, 1.0, 6.0), "strap_mid_brown", "Torso"),
    PartSpec("strap_buckle_left", (-9.0, -7.5, 52.5), (2.0, 1.0, 3.0), "iron_deep", "Torso"),
    PartSpec("strap_buckle_right", (9.0, -7.5, 52.5), (2.0, 1.0, 3.0), "iron_deep", "Torso"),
    ...
    PartSpec("upper_arm_high_left", (-19.5, 1.5, 51.5), (9.0, 8.0, 5.0), "fur_mid", "UpperArm.L"),
    PartSpec("upper_arm_low_left", (-19.5, 1.5, 47.0), (9.0, 8.0, 4.0), "fur_deep", "UpperArm.L"),
    PartSpec("elbow_left", (-19.5, 1.5, 43.5), (8.0, 8.0, 3.0), "fur_high", "LowerArm.L"),
    PartSpec("forearm_high_left", (-19.5, 1.5, 39.5), (9.0, 8.0, 5.0), "fur_mid", "LowerArm.L"),
    PartSpec("forearm_low_left", (-19.5, 1.5, 35.0), (9.0, 8.0, 4.0), "fur_deep", "LowerArm.L"),
    ...
    PartSpec("upper_arm_high_right", (19.5, 1.5, 51.5), (9.0, 8.0, 5.0), "fur_mid", "UpperArm.R"),
    PartSpec("upper_arm_low_right", (19.5, 1.5, 47.0), (9.0, 8.0, 4.0), "fur_deep", "UpperArm.R"),
    PartSpec("elbow_right", (19.5, 1.5, 43.5), (8.0, 8.0, 3.0), "fur_high", "LowerArm.R"),
    PartSpec("forearm_high_right", (19.5, 1.5, 39.5), (9.0, 8.0, 5.0), "fur_mid", "LowerArm.R"),
    PartSpec("forearm_low_right", (19.5, 1.5, 35.0), (9.0, 8.0, 4.0), "fur_deep", "LowerArm.R"),
    ...
    PartSpec("muzzle_bridge", (0.0, -5.0, 63.5), (10.0, 2.0, 7.0), "muzzle_high", "Head"),
    PartSpec("muzzle_cheek_left", (-9.5, -7.0, 61.0), (3.0, 4.0, 6.0), "muzzle_mid", "Head"),
    PartSpec("muzzle_cheek_right", (9.5, -7.0, 61.0), (3.0, 4.0, 6.0), "muzzle_mid", "Head"),
    PartSpec("broad_scapular_snout", (0.0, -8.0, 60.0), (16.0, 4.0, 6.0), "muzzle_mid", "Head"),
    PartSpec("nostril_left", (-5.0, -12.0, 60.0), (4.0, 4.0, 4.0), "muzzle_deep", "Head"),
    PartSpec("nose_plane_center", (0.0, -12.0, 60.0), (6.0, 4.0, 4.0), "muzzle_high", "Head"),
    PartSpec("nostril_right", (5.0, -12.0, 60.0), (4.0, 4.0, 4.0), "muzzle_deep", "Head"),
