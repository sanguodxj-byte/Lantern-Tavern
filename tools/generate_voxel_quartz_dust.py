...
def build_model():
    dust = make_material("qd_dust", (0.85, 0.88, 0.92, 1.0), roughness=0.55)
    dark = make_material("qd_dark", (0.55, 0.58, 0.65, 1.0), roughness=0.60)
    crystal = make_material("qd_crystal", (0.75, 0.90, 1.0, 1.0), roughness=0.25, emission=0.4)
    tip = make_material("qd_tip", (0.95, 0.98, 1.0, 1.0), roughness=0.18, emission=0.9)
