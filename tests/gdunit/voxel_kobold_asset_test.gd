...
const GLB_PATH := "res://assets/meshes/characters/voxel_kobold_42px.glb"
const RIG_GLB_PATH := "res://assets/meshes/characters/voxel_kobold_42px_rig.glb"
const GENERATOR_PATH := "res://tools/generate_voxel_kobold.py"
const PREVIEW_PREVIEW := "res://reports/characters_preview/voxel_kobold_render_preview.png"
const PREVIEW_FRONT := "res://reports/characters_preview/voxel_kobold_render_front.png"
